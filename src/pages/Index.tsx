  ...
  return (
    <div className="min-h-screen bg-sci-fi overflow-x-hidden">
      ...
      <header className="flex items-center justify-between px-4 pt-6 pb-2">
        <span className="text-gradient-purple text-lg font-bold tracking-tight">CryptoShop</span>
        <LangToggle />
      </header>
      ...
      <section className="px-4 py-6">
        <motion.div
          ...
          className="glass-panel p-8 glow-purple relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-primary/10 text-[10px] font-medium text-primary">
                {t.networkLabel}
              </span>
            </div>
            ...
            <div className="text-center py-4">
              ...
              <div className="flex items-baseline justify-center gap-2">
                ...
                <span className="font-mono-num text-6xl font-bold text-primary leading-none">
                  {usdt?.buybackRate.toFixed(2)}
                </span>
